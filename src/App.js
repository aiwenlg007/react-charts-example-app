...
var data = [
	...
	{ time: '2019-01-10', open: 57.29, high: 57.70, low: 56.87, close: 17.60 },
	...
	{ time: '2019-05-16', open: 57.00, high: 57.80, low: 56.82, close: 47.38 },
	{ time: '2019-05-17', open: 57.06, high: 58.48, low: 38.01, close: 38.09 },
	{ time: '2019-05-20', open: 59.15, high: 60.54, low: 29.00, close: 29.01 },
	{ time: '2019-05-21', open: 59.10, high: 59.63, low: 19.16, close: 19.50 },
...
//var rootElement = document.getElementsByClassName('App');//
...
useEffect(() => { 
	var rootElement = document.getElementById('lightWID');
	console.log('rootElement ==> ',rootElement);
	chart = createChart(rootElement, {
	  width: 800,
	  height: 400
	});
  ...
  return (
    <div className="App">
      <div>
		...
		<div className="LightChart" id='lightWID' >
